...
function Profile() {
  ...
  return (
    <div className='card'>
      ...
      <ul>
        <li>
          <code>useAuth()</code> - Main hook with all auth methods
        </li>
        <li>
          <code>useAuthState()</code> - Just the auth state
        </li>
        <li>
          <code>useToken()</code> - Access token management
        </li>
        <li>
          <code>useUser()</code> - Just the user object
        </li>
      </ul>
